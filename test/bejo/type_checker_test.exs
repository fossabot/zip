defmodule Bejo.TypeCheckerTest do
  ...
  test "infer type of atom expressions" do
    ...
    {:atom, {1, 0, 2}, :a} = ast = Bejo.Parser.expression!(str)
  ...
  test "infer function's return type" do
    ...
    {:module, _, [function]} = ast = Bejo.Parser.parse_module(str, "test")
  ...
  test "infer return type of another function in the module" do
    ...
    {:module, _, [foo, _bar]} = ast = Bejo.Parser.parse_module(str, "test")
  ...
  test "infer function with variable assignments which get used in function calls" do
    ...
    {:module, _, [function]} = ast = Bejo.Parser.parse_module(str, "test1")
